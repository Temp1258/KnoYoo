        ...
        CareerTemplate {
            ...
            skills: vec![
                ...
                TemplateSkill {
                    ...
                    children: vec![
                        "ES6+ 语法".into(),
                        "TypeScript 类型系统".into(),
                        "异步编程".into(),
                        "模块化".into(),
                    ],
                },
                TemplateSkill {
                    name: "React/Vue 框架".into(),
                    importance: 5,
                    children: vec![
                        "组件设计".into(),
                        "状态管理".into(),
                ...
                TemplateSkill {
                    name: "性能优化".into(),
                    importance: 4,
                    children: vec!["懒加载".into(), "缓存策略".into(), "Core Web Vitals".into()],
                },
                TemplateSkill {
                    name: "Node.js".into(),
                    importance: 3,
                    children: vec!["Express/Koa".into(), "SSR".into(), "BFF 层".into()],
                },
            ],
        },
        CareerTemplate {
            ...
            skills: vec![
                ...
                TemplateSkill {
                    name: "安全".into(),
                    importance: 3,
                    children: vec!["认证授权".into(), "数据加密".into(), "OWASP".into()],
                },
            ],
        },
        CareerTemplate {
            ...
            skills: vec![
                TemplateSkill {
                    name: "前端开发".into(),
                    importance: 5,
                    children: vec!["React/Vue".into(), "HTML/CSS".into(), "TypeScript".into()],
                },
                TemplateSkill {
                    name: "后端开发".into(),
                    importance: 5,
                    children: vec!["Node.js/Python".into(), "REST API".into(), "GraphQL".into()],
                },
                TemplateSkill {
                    name: "数据库".into(),
                    importance: 4,
                    children: vec!["PostgreSQL/MySQL".into(), "MongoDB".into(), "ORM".into()],
                },
                TemplateSkill {
                    name: "部署运维".into(),
                    importance: 4,
                    children: vec!["Docker".into(), "云服务".into(), "Nginx".into()],
                },
                TemplateSkill {
                    name: "产品思维".into(),
                    importance: 3,
                    children: vec!["需求分析".into(), "用户体验".into(), "数据驱动".into()],
                },
            ],
        },
        CareerTemplate {
            ...
            skills: vec![
                TemplateSkill {
                    name: "SQL".into(),
                    importance: 5,
                    children: vec!["复杂查询".into(), "窗口函数".into(), "数据建模".into()],
                },
                TemplateSkill {
                    name: "Python 数据分析".into(),
                    importance: 5,
                    children: vec!["Pandas".into(), "NumPy".into(), "数据清洗".into()],
                },
                TemplateSkill {
                    name: "统计学".into(),
                    importance: 4,
                    children: vec!["假设检验".into(), "回归分析".into(), "A/B 测试".into()],
                },
                TemplateSkill {
                    name: "数据可视化".into(),
                    importance: 4,
                    children: vec![
                        "Tableau/PowerBI".into(),
                        "ECharts".into(),
                        "数据叙事".into(),
                    ],
                },
                TemplateSkill {
                    name: "业务分析".into(),
                    importance: 4,
                    children: vec!["指标体系".into(), "归因分析".into(), "漏斗分析".into()],
                },
                TemplateSkill {
                    name: "机器学习基础".into(),
                    importance: 3,
                    children: vec!["分类/回归".into(), "聚类".into(), "特征工程".into()],
                },
            ],
        },
        CareerTemplate {
            ...
            skills: vec![
                ...
                TemplateSkill {
                    ...
                    children: vec![
                        "CNN".into(),
                        "RNN/Transformer".into(),
                        "PyTorch/TensorFlow".into(),
                    ],
                },
                TemplateSkill {
                    name: "NLP".into(),
                ...
                TemplateSkill {
                    name: "MLOps".into(),
                    importance: 4,
                    children: vec!["模型部署".into(), "模型监控".into(), "实验管理".into()],
                },
                TemplateSkill {
                    name: "数据工程".into(),
                    importance: 4,
                    children: vec!["ETL 管道".into(), "特征存储".into(), "数据质量".into()],
                },
                TemplateSkill {
                    name: "Prompt 工程".into(),
                    importance: 3,
        ...
        CareerTemplate {
            ...
            skills: vec![
                ...
                TemplateSkill {
                    name: "项目管理".into(),
                    importance: 4,
                    children: vec!["敏捷开发".into(), "路线图".into(), "跨团队协作".into()],
                },
                TemplateSkill {
                    name: "商业思维".into(),
                    importance: 4,
                    children: vec!["商业模式".into(), "增长策略".into(), "竞争分析".into()],
                },
                TemplateSkill {
                    name: "技术理解".into(),
                    importance: 3,
                    children: vec!["API 基础".into(), "数据库概念".into(), "前后端架构".into()],
                },
            ],
        },
        CareerTemplate {
            ...
            skills: vec![
                TemplateSkill {
                    name: "Linux 系统管理".into(),
                    importance: 5,
                    children: vec!["Shell 脚本".into(), "系统调优".into(), "网络配置".into()],
                },
                TemplateSkill {
                    name: "容器技术".into(),
                    importance: 5,
                    children: vec!["Docker".into(), "Kubernetes".into(), "Helm".into()],
                },
                TemplateSkill {
                    name: "CI/CD".into(),
                    importance: 5,
                    children: vec![
                        "Jenkins/GitLab CI".into(),
                        "自动化测试".into(),
                        "制品管理".into(),
                    ],
                },
                TemplateSkill {
                    name: "云平台".into(),
                    importance: 4,
                    children: vec!["AWS/阿里云".into(), "Terraform".into(), "Serverless".into()],
                },
                TemplateSkill {
                    name: "监控告警".into(),
                    importance: 4,
                    children: vec!["Prometheus".into(), "Grafana".into(), "日志管理".into()],
                },
            ],
        },
        CareerTemplate {
            ...
            skills: vec![
                ...
                TemplateSkill {
                    name: "交互设计".into(),
                    importance: 5,
                    children: vec!["原型设计".into(), "信息架构".into(), "动效设计".into()],
                },
                TemplateSkill {
                    name: "用户研究".into(),
                    importance: 4,
                    children: vec!["用户访谈".into(), "可用性测试".into(), "用户画像".into()],
                },
                TemplateSkill {
                    name: "设计工具".into(),
                    importance: 4,
                    children: vec!["Figma".into(), "Sketch".into(), "Adobe 套件".into()],
                },
                TemplateSkill {
                    name: "设计系统".into(),
                    importance: 3,
                    children: vec!["组件库".into(), "设计规范".into(), "Design Token".into()],
                },
            ],
        },
        CareerTemplate {
            ...
            skills: vec![
                TemplateSkill {
                    name: "原生开发".into(),
                    importance: 5,
                    children: vec!["Swift/Kotlin".into(), "UI 组件".into(), "生命周期".into()],
                },
                TemplateSkill {
                    name: "跨平台框架".into(),
                    importance: 5,
                    children: vec!["React Native".into(), "Flutter".into(), "性能调优".into()],
                },
                TemplateSkill {
                    name: "移动端架构".into(),
                    importance: 4,
                    children: vec!["MVVM".into(), "状态管理".into(), "离线存储".into()],
                },
                TemplateSkill {
                    name: "性能优化".into(),
                    importance: 4,
                    children: vec!["启动优化".into(), "内存管理".into(), "包体积优化".into()],
                },
                TemplateSkill {
                    name: "发布运维".into(),
                    importance: 3,
                    children: vec!["热更新".into(), "崩溃监控".into(), "应用商店".into()],
                },
            ],
        },
        CareerTemplate {
            ...
            skills: vec![
                TemplateSkill {
                    name: "网络安全基础".into(),
                    importance: 5,
                    children: vec!["TCP/IP".into(), "防火墙".into(), "VPN".into()],
                },
                TemplateSkill {
                    name: "Web 安全".into(),
                    importance: 5,
                    children: vec!["XSS/CSRF".into(), "SQL 注入".into(), "OWASP Top 10".into()],
                },
                TemplateSkill {
                    name: "渗透测试".into(),
                    importance: 4,
                    children: vec!["漏洞扫描".into(), "社工攻击".into(), "红蓝对抗".into()],
                },
                TemplateSkill {
                    name: "安全运营".into(),
                    importance: 4,
                    children: vec!["SIEM".into(), "应急响应".into(), "安全审计".into()],
                },
                TemplateSkill {
                    name: "密码学".into(),
                    importance: 3,
                    children: vec!["加密算法".into(), "PKI".into(), "零信任".into()],
                },
            ],
        },
        CareerTemplate {
            ...
            skills: vec![
                TemplateSkill {
                    name: "数据仓库".into(),
                    importance: 5,
                    children: vec!["维度建模".into(), "数据分层".into(), "数据质量".into()],
                },
                TemplateSkill {
                    name: "大数据技术".into(),
                    importance: 5,
                ...
                TemplateSkill {
                    name: "ETL 开发".into(),
                    importance: 4,
                    children: vec!["Airflow".into(), "数据清洗".into(), "调度系统".into()],
                },
                TemplateSkill {
                    name: "SQL".into(),
                    importance: 4,
                    children: vec!["复杂查询".into(), "性能优化".into(), "数据建模".into()],
                },
                TemplateSkill {
                    name: "云数据平台".into(),
                    importance: 3,
                    children: vec!["Snowflake".into(), "Databricks".into(), "数据湖".into()],
                },
            ],
        },
        CareerTemplate {
            ...
            skills: vec![
                ...
                TemplateSkill {
                    name: "性能测试".into(),
                    importance: 4,
                    children: vec!["JMeter".into(), "压力测试".into(), "性能分析".into()],
                },
                TemplateSkill {
                    name: "测试管理".into(),
                    importance: 3,
                    children: vec!["缺陷管理".into(), "测试计划".into(), "质量报告".into()],
                },
            ],
        },
        CareerTemplate {
            ...
            skills: vec![
                TemplateSkill {
                    name: "区块链原理".into(),
                    importance: 5,
                    children: vec!["共识算法".into(), "加密学".into(), "P2P 网络".into()],
                },
                TemplateSkill {
                    name: "智能合约".into(),
                    importance: 5,
                    children: vec!["Solidity".into(), "合约安全".into(), "Gas 优化".into()],
                },
                TemplateSkill {
                    name: "DApp 开发".into(),
                    importance: 4,
                    children: vec!["Web3.js".into(), "钱包集成".into(), "IPFS".into()],
                },
                TemplateSkill {
                    name: "DeFi/NFT".into(),
                    importance: 3,
                    children: vec!["AMM".into(), "借贷协议".into(), "NFT 标准".into()],
                },
            ],
        },
        CareerTemplate {
            ...
            skills: vec![
                TemplateSkill {
                    name: "游戏引擎".into(),
                    importance: 5,
                    children: vec!["Unity".into(), "Unreal Engine".into(), "场景管理".into()],
                },
                TemplateSkill {
                    name: "编程基础".into(),
                    importance: 5,
                    children: vec!["C#/C++".into(), "数据结构".into(), "算法".into()],
                },
                TemplateSkill {
                    name: "图形学".into(),
                    importance: 4,
                    children: vec!["Shader 编程".into(), "渲染管线".into(), "光照模型".into()],
                },
                TemplateSkill {
                    name: "游戏设计".into(),
                    importance: 3,
                    children: vec!["关卡设计".into(), "数值平衡".into(), "用户体验".into()],
                },
            ],
        },
        CareerTemplate {
            ...
            skills: vec![
                ...
                TemplateSkill {
                    name: "内容营销".into(),
                    importance: 5,
                    children: vec!["文案写作".into(), "SEO".into(), "社媒运营".into()],
                },
                TemplateSkill {
                    name: "数据分析".into(),
                    importance: 4,
                    children: vec!["GA/百度统计".into(), "归因分析".into(), "ROI 计算".into()],
                },
                TemplateSkill {
                    name: "广告投放".into(),
                    importance: 4,
                    children: vec!["SEM".into(), "信息流广告".into(), "素材优化".into()],
                },
                TemplateSkill {
                    name: "品牌建设".into(),
                    importance: 3,
                    children: vec!["品牌定位".into(), "PR 策略".into(), "社区运营".into()],
                },
            ],
        },
        CareerTemplate {
            ...
            skills: vec![
                ...
                TemplateSkill {
                    name: "沟通协作".into(),
                    importance: 4,
                    children: vec!["干系人管理".into(), "冲突解决".into(), "汇报技巧".into()],
                },
                TemplateSkill {
                    name: "质量管理".into(),
                    importance: 4,
                    children: vec!["验收标准".into(), "缺陷跟踪".into(), "持续改进".into()],
                },
                TemplateSkill {
                    name: "工具使用".into(),
                    importance: 3,
                    children: vec!["Jira".into(), "Confluence".into(), "飞书/钉钉".into()],
                },
            ],
        },
        CareerTemplate {
            ...
            skills: vec![
                TemplateSkill {
                    name: "C/C++".into(),
                    importance: 5,
                    children: vec!["指针/内存管理".into(), "嵌入式 C".into(), "代码优化".into()],
                },
                TemplateSkill {
                    name: "硬件基础".into(),
                    importance: 5,
                ...
                TemplateSkill {
                    name: "RTOS".into(),
                    importance: 4,
                    children: vec!["FreeRTOS".into(), "任务调度".into(), "中断处理".into()],
                },
                TemplateSkill {
                    name: "通信协议".into(),
                    importance: 4,
                    children: vec!["SPI/I2C/UART".into(), "CAN 总线".into(), "BLE".into()],
                },
                TemplateSkill {
                    name: "IoT".into(),
                    importance: 3,
                    children: vec!["MQTT".into(), "边缘计算".into(), "OTA 升级".into()],
                },
            ],
        },
        CareerTemplate {
            ...
            skills: vec![
                ...
                TemplateSkill {
                    name: "架构设计".into(),
                    importance: 5,
                    children: vec!["微服务架构".into(), "事件驱动".into(), "高可用设计".into()],
                },
                TemplateSkill {
                    name: "容器编排".into(),
                    importance: 4,
                    children: vec!["Kubernetes".into(), "Service Mesh".into(), "GitOps".into()],
                },
                TemplateSkill {
                    name: "安全合规".into(),
                    importance: 4,
                    children: vec!["IAM".into(), "网络安全".into(), "合规审计".into()],
                },
            ],
        },
        CareerTemplate {
            ...
            skills: vec![
                TemplateSkill {
                    name: "内容策划".into(),
                    importance: 5,
                    children: vec!["选题策划".into(), "内容日历".into(), "热点追踪".into()],
                },
                TemplateSkill {
                    name: "视频制作".into(),
                    importance: 5,
                    children: vec!["拍摄技巧".into(), "剪辑软件".into(), "封面设计".into()],
                },
                TemplateSkill {
                    name: "文案写作".into(),
                    importance: 4,
                    children: vec!["标题技巧".into(), "故事叙述".into(), "SEO 写作".into()],
                },
                TemplateSkill {
                    name: "粉丝运营".into(),
                    importance: 4,
                    children: vec!["社区互动".into(), "涨粉策略".into(), "商业变现".into()],
                },
                TemplateSkill {
                    name: "数据分析".into(),
                    importance: 3,
                    children: vec!["平台数据".into(), "用户画像".into(), "内容复盘".into()],
                },
            ],
        },
        CareerTemplate {
            ...
            skills: vec![
                ...
                TemplateSkill {
                    name: "绩效管理".into(),
                    importance: 5,
                    children: vec!["OKR/KPI".into(), "绩效面谈".into(), "360 评估".into()],
                },
                TemplateSkill {
                    name: "组织发展".into(),
                    importance: 4,
                    children: vec!["组织架构".into(), "文化建设".into(), "人才梯队".into()],
                },
                TemplateSkill {
                    name: "劳动法规".into(),
                    importance: 4,
                    children: vec!["劳动合同".into(), "社保公积金".into(), "劳动仲裁".into()],
                },
                TemplateSkill {
                    name: "培训发展".into(),
                    importance: 3,
                    children: vec!["培训体系".into(), "新人融入".into(), "领导力发展".into()],
                },
            ],
        },
    ]
...
只输出 JSON，不要任何解释。"
    ...
    let career_name = parsed["career"]
        ...
        .trim()
        .to_string();
    let skills_arr = parsed["skills"].as_array().ok_or("AI 未返回 skills 数组")?;
